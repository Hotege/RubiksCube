...
void mainLoop(void* pParam)
{
	...
	GLfloat colorRed[] = { 184.0f / 255, 10.0f / 255, 49.0 / 255, 1 };
	renderButton(btnRed, colorRed, whiteText);
	GLfloat colorGreen[] = { 0, 156.0f / 255, 70.0 / 255, 1 };
	renderButton(btnGreen, colorGreen, whiteText);
	GLfloat colorYellow[] = { 1, 214.0f / 255, 0, 1 };
	renderButton(btnYellow, colorYellow, blackText);
	GLfloat colorOrange[] = { 1, 87.0f / 255, 0, 1 };
	renderButton(btnOrange, colorOrange, whiteText);
	GLfloat colorBlue[] = { 0, 68.0f / 255, 147.0f / 255, 1 };
